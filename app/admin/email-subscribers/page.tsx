// Copy of src/pages/EmailSubscribers.tsx for Next.js 14 App Router
    ...
    <div className="min-h-screen pt-24 px-4 pb-20 animate-in fade-in duration-500">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/admin" className="px-4 py-2 glass rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors font-bold text-gray-900 dark:text-white">
            Back to Admin
          </Link>
        </div>
