      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map(post => (
              <Link key={post.id} to={`/blog/${post.slug}`} className="glass rounded-3xl bg-white/5 border border-white/10 overflow-hidden group hover:bg-white/10 transition-all flex flex-col shadow-[0_0_20px_rgba(0,255,255,0.02)]">
