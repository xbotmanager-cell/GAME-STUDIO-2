...
export default function Admin() {
  ...
  const handleAdminLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (adminEmail === 'lupinstarnley009@gmail.com' && adminPassword === '2892') {
      setIsAuthenticated(true);
    ...
    <div className="max-w-4xl mx-auto px-4 py-12 pb-32 animate-in fade-in">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex space-x-4">
          <Link to="/admin/email-subscribers" className="px-4 py-2 rounded-lg bg-cyan-500/20 text-cyan-500 hover:bg-cyan-500/30 transition-colors font-bold text-sm">
            Email Subscribers
          </Link>
