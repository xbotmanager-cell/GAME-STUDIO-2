...
export default function Collection() {
  ...
  if (!collection) {
    return (
      <div className="flex flex-col items-center justify-center h-screen text-center px-4">
        ...
        <Link to="/collections" className="glass px-6 py-2 rounded-full text-cyan-500 glow-hover">
          Back to Collections
        </Link>
      </div>
    );
  ...
  return (
    <div className="min-h-screen pt-24 px-4 pb-20 max-w-6xl mx-auto animate-in fade-in duration-500">
      <Link to="/collections" className="flex items-center space-x-2 text-cyan-500 mb-8 hover:text-cyan-400 transition-colors">
        <ArrowLeft size={20} />
