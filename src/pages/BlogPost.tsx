  ...
  if (!post) {
    return (
      <div className="min-h-screen pt-32 text-center text-white">
        ...
        <Link to="/blog" className="text-cyan-500 hover:underline">Back to News</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen pt-24 px-4 pb-20 animate-in fade-in duration-500">
      <div className="max-w-4xl mx-auto">
        <Link to="/blog" className="inline-flex items-center space-x-2 text-cyan-500 font-bold mb-8 hover:text-cyan-400 transition-colors">
          <ArrowLeft size={20} />
